The line `var intColorless = currentCost.replace(/[^\d]/g, "");` is a JavaScript statement that manipulates a string, specifically `currentCost`. Let me break down what it does:
